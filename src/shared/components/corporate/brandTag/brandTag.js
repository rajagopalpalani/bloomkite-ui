    ...
    render() {
        ...
        return (
            <div>
                ...
                <div className="row col-12 advisor-gap" style={{ minHeight: this.state.heightIncrease }}>
                    <CorporateLeftbar
                    ...
                    <div className="col-10 nopadding">
                        <div className="col-12 center-page row">
                                    ...
                                    {advBrandProducts &&
                                        ...
                                        advBrandProducts.map((advBrandProduct, index) => {
                                            ...
                                            let showServices = (service, serviceIndex, prodIndex) => {
                                                ...
                                                return (
                                                    <div className="form-group row nomargin nopadding" key={'brand-product-' + serviceIndex + prodIndex}>
                                                        <div className="col-3">
                                                        ...
                                                        <div className="col-3 brand-list-align">
                                                            <select
                                                                ...
                                                                <option value="0">{corporateMessage.brandTag1}</option>
                                                        ...
                                                        <div className="col-3 brand-list-align">
                                                            <select
                                                                ...
                                                                onChange={(e) => self.handleBrandTagChange(e, prodIndex, serviceIndex)}>
                                                                <option value="0">{corporateMessage.brandTag2}</option>
                                                        ...
                                                        <div className="col-3 brand-list-align brand-width">
                                                            <select
                                                                className="text-border-pi"
                                                                name="brandId3"
                                                                value={service.brandId3}
                                                                onChange={(e) => self.handleBrandTagChange(e, prodIndex, serviceIndex)}>
                                                                <option value="0">{corporateMessage.brandTag3}</option>
