                                ...
                                <form className="form">
                                    <div className="row">
                                        <div className="col-lg-12">
                                            <label className="password-font">{advisorMessage.passwordOld}</label>
                                        </div>
                                        <div className="col-lg-12">
                                            <PasswordInput
                                        ...
                                        <div className="col-lg-12">
                                            <label className="password-font">{advisorMessage.passwordNew}</label>
                                        </div>
                                        <div className="col-lg-12">
                                            <PasswordInput
                                                parentClassName="text-box-container password-box"
                                        ...
                                        <div className="col-lg-12">
                                            <label className="password-font">{advisorMessage.passwordConfirm}</label>
                                        </div>
                                        <div className="col-lg-12">
                                            <PasswordInput
                                                parentClassName="text-box-container password-box"
