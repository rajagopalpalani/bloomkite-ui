...
import { licenseMethod, contentMethod, maxLength, aplhaNumericMethod } from '../../../constants/commonRules';
...
class ProductService extends React.Component {
    ...
    handleCheckChieldElement = (event, services) => {
        let checkServices = services;
        checkServices.forEach((service) => {
            if (service.value === event.target.value) service.isChecked = event.target.checked;
        });
        this.handleAdvProductsText(e, index);
    };
                                    ...
                                    <Tabs id="product-service-tab" className="product-bgcolor" activeKey={tabKey} onSelect={(value) => this.onChange('tabKey', value)}>
                                        {this.state.advProducts.length > 0 ? (
                                            this.state.advProducts.map((advProduct, index) => {
                                                ...
                                                const services =
                                                    advProduct.services &&
                                                    advProduct.services.length > 0 &&
                                                    advProduct.services.map((item) => ({ label: item.service, value: item.serviceId }));
                                                    ...
                                                    <Tab
                                                        ...
                                                        <div className="form-group row" key={`advProducts-${index}`}>
                                                            ...
                                                            <div className="col-12 row">
                                                                <div className="col-6">
                                                                    <div>
                                                                        <label>{advisorMessage.productName}</label>
                                                                        <select
                                                                            ...
                                                                            <option value="">{advisorMessage.productSelect}</option>
                                                                            {this.showProducts(index, advProduct.showProducts)}
                                                                        </select>
                                                                    </div>
                                                                    <div>
                                                                        <label>{advisorMessage.productLicense}</label>
                                                                        <select
                                                                            className="text-border-prod"
                                                                            name="licId"
                                                                            id="licId"
                                                                            ...
                                                                            <option value="">{advisorMessage.productLicenseSelect}</option>
                                                                            {this.showLicense(index, advProduct.licences)}
                                                                        </select>
                                                                    </div>
                                                                    <div>
                                                                        <label className="licNum">{advisorMessage.productLicenseNumber}</label>
                                                                        <input
                                                                            className="text-border-prod"
                                                                            autoComplete="off"
                                                                            name="licNumber"
                                                                    ...
                                                                    <div>
                                                                        <label>{advisorMessage.productIssued}</label>
                                                                        <input
                                                                            className="text-border-prod"
                                                                            autoComplete="off"
                                                                            name="issuedBy"
                                                                    ...
                                                                    <div>
                                                                        <label>{advisorMessage.productVality}</label>
                                                                        <CustomDatePicker
                                                                    ...
                                                                    <div>
                                                                        <label>{advisorMessage.productRenumeration}</label>
                                                                        <select
                                                                            className="text-border-prod"
                                                                            name="remId"
                                                                            id="remId"
                                                                            ...
                                                                            <option value="">{advisorMessage.productSelectRenumeration}</option>
                                                                ...
                                                                <div className="col-6">
                                                                    <div>
                                                                        <label>{advisorMessage.productService}</label>
                                                                        {/* {(advProduct.prodId) ?
                                  <div>
                                    <input type="checkbox" onChange={(e) => this.handleAllChecked(e, advProduct.services)} value="checkedall" /> Check / Uncheck All
                                    <ul>
                                      {
                                        advProduct.services.map((service, index) => {
                                          return (<CheckBox key={index} handleCheckChieldElement={this.handleCheckChieldElement}  {...service} />)
                                        })
                                      }
                                    </ul></div> : null} */}
                                                                        {/* {(advProduct.prodId) ?
