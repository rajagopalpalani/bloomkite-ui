...
import { onChange, calculate, clearRateFinder } from '../../../actions/rateFinder';
...
class RateFinderWithoutLogin extends Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    componentDidUpdate(newProps, oldProps) {
        let { requestCount, presentValue, duration, futureValue } = newProps;
...
export default connect(mapStateToPros, mapDispatchToProps)(RateFinderWithoutLogin);
