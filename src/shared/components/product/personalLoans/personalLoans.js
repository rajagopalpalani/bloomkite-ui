...
class PersonalLoans extends React.Component {
    ...
    render() {
        return (
            <div>
                <ProfileHeader showProduct={true} personalLoans={true} advisorDetails={this.props.advisorDetails} />
