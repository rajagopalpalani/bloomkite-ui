...
class AdvisorSignup extends React.Component {
    constructor(props) {
        super(props);
        const { advisorDetails, phoneNumber } = props;
        this.state = {
            emailId: '',
            name: '',
            userNameError: '',
    ...
    render() {
        const { emailId, name, panNumber, password, confirmPassword, phoneNumber, userName } = this.state;
        if (this.props.clear && !this.state.clear) {
            this.clearState();
        }
        return (
            <div id="signup" className="new-signup-details">
                {this.props.loggedDetails && this.props.loggedDetails.roleBasedId && <Redirect to="advisor" />}
                <div>
                        ...
                        <div id="individual" className="signup-form-group">
                            <div className="row">
                                ...
                                <div className="col-xs-6 signup-box-top">
                                    <label className="signup-label">{signupMessage.signupPanNumber}</label>
                                    <input
                                        ...
                                        noValidate
                                    />
                                    {this.state.panNumberInfo && <span className="panNumberInfo signup-color">{signupMessage.panInfo}</span>}
                                </div>
                            </div>
                            <div className="row">
                                <div className="col-xs-6 signup-box-top  box-side">
                    ...
                    <div className="new-signup-check-elm">
                        ...
                        <button type="submit" className="btn btn-primary btn-lg new-signup-btn" onClick={(e) => this.handleSignup(e)}>
                            Create Account
                        </button>
                    </div>
...
export default connect(mapStateToProps, { signupUser, validateUniqueFields })(AdvisorSignup);
